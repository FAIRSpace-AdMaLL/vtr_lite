...
class SuperPoint(torch.nn.Module): #SuperPointNet_gauss2
    ...
    def __init__(self, config, subpixel_channel=1):
        super().__init__() #SuperPointNet_gauss2
    ...
    def forward(self, data):
        ...
        #print(descriptors)
        #exit()
        output = {'keypoints': keypoints, 'scores': scores, 'descriptors': descriptors}
